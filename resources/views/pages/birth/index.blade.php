        ...
        <table class="w-full whitespace-no-wrap" id="data-table">
          ...
          >
            <tr class="text-gray-700 dark:text-gray-400">
              ...
              <td class="px-4 py-3">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  {{ $birth->familyCard->family_number }}
                </p>
              </td>
              <td class="px-4 py-3 flex flex-column">
                ...
                <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-red-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" href="birth/{{ $birth->id }}/confirm">
                  <svg
                    class="w-5 h-5"
                    aria-hidden="true"
                    fill="currentColor"
