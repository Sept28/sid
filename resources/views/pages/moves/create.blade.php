      ...
      <div class="container px-6 mx-auto grid">
        ...
        >
          <div class="flex items-center">
            ...
            <span>Tambah Penduduk Pindahan</span>
          </div>
          <span></span>
        </a>
        ...
        >
          <form action="{{ route('move.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <label class="block mt-4 text-sm">
              ...
              >
                @foreach ($movers as $mover)
                  <option value="{{ $mover->id }}">{{ $mover->id_number }} / {{ $mover->name }}</option>
                @endforeach
              </select>
            </label>
            ...
            <div class="mt-4 text-sm">
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Tanggal Pindah</span>
                <input
