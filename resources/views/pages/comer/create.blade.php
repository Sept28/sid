...
@section('content')
    <main class="h-full pb-16 overflow-y-auto">
      <div class="container px-6 mx-auto grid">
        ...
        >
          <form action="{{ route('comer.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <label class="block mt-4 text-sm">
              ...
              >
                ...
                @foreach ($reporters as $reporter)
                  <option value="{{ $reporter->id }}">{{ $reporter->id_number }} / {{ $reporter->name }}</option>
                @endforeach
              </select>
            </label>
