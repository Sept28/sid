        ...
        >
            ...
            <label class="block mt-4 text-sm">
              ...
              >
                ...
                @foreach ($families as $family)
                    <option value="{{ $family->villager ? $family->villager->id : '' }}">{{ $family->villager ? $family->villager->name : '' }}</option>
                @endforeach
              </select>
            </label>
          </div>
          ...
          >
            <button
              ...
              formaction="{{ route('family.filter-reset') }}"
              >
              Reset
            </button>
            <button
              class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
              formaction="{{ route('family.index') }}"
            >
              Accept
            </button>
          </footer>
          ...
          <table class="w-full whitespace-no-wrap" id="data-table">
            ...
            >
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3">
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                    {{ $family->villager ? $family->villager->name : '-' }}
                  </p>
                </td>
                <td class="px-4 py-3">
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <td class="px-4 py-3 flex flex-column">
                  ...
                  <a
                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                    aria-label="Show"
                    href="{{ route('family.show', $family->id) }}"
                  >
                  ...
                  <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-red-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" href="family/{{ $family->id }}/confirm">
                    <svg
                      class="w-5 h-5"
                      aria-hidden="true"
                      fill="currentColor"
