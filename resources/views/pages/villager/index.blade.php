        ...
        >
          ...
          >
            <button
              ...
              formaction="{{ route('villager.filter-reset') }}"
              >
              Reset
            </button>
            <button
              class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
              formaction="{{ route('villager.index') }}"
            >
              Accept
            </button>
          </footer>
      ...
      <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
          <table class="w-full whitespace-no-wrap" id="myTable">
            ...
            @foreach ($villagers as $index=>$villager)
            <tbody
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 flex flex-column">
                  <a
                    ...
                    aria-label="Edit"
                    href="{{ route('villager.edit', $villager->id) }}"
                  >
                    <svg
                      class="w-5 h-5"
                      aria-hidden="true"
                  ...
                  <a
                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                    aria-label="Show"
                    href="{{ route('villager.show', $villager->id) }}"
                  >
                  ...
                  <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-red-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" href="villager/{{ $villager->id }}/confirm">
                    <svg
                      class="w-5 h-5"
                      aria-hidden="true"
                      fill="currentColor"
